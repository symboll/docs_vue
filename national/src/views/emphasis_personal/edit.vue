  ...
  data () {
    return {
      createOrEditForm: [
        ...
        { label: '地域', key: 'zone', type: 'el-select' },
        { label: '组织类别', key: 'organizationType', type: 'el-select' },
        { label: '人员类别', key: 'personnelType', type: 'el-select' },
        { label: '人员等级', key: 'personnelLevel', type: 'el-select' },
